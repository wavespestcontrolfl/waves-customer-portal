...
const FAQ_DATA = [
  ...
  },
  {
    ...
    questions: [
      { q: 'How does WaveGuard bundling save me money?', a: 'The more services you bundle, the bigger the discount: Silver (2 services) = 10% off, Gold (3) = 15% off, Platinum (4+) = 20% off everything. The discount applies to ALL your recurring services, not just the new one.' },
