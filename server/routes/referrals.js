...
router.post('/', async (req, res, next) => {
  try {
    ...
    try {
      ...
      // No quiet-hours requeue: referrals_legacy_invite is a
      // customer-action entry point (owner ruling 2026-08-29, referral
      // invites confirmed explicitly) — the invite sends immediately, at
      // any hour, and QUIET_HOURS_HOLD cannot surface here.
      if (!smsResult.sent) {
