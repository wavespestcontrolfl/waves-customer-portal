        ...
        try {
          ...
          await db('sms_log').insert({
            ...
            metadata: JSON.stringify({
              ...
              // Carried to the terminal email fallback so a quiet-hours text
              // that later fails still produces the truthful outcome line.
              cancellation_processed: isCancellation ? cancellationProcessed : undefined,
