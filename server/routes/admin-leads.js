...
router.post('/:id/assign', async (req, res, next) => {
  try {
    ...
    // Log first response if this is the first assignment
...
router.get('/campaigns', async (req, res, next) => {
  try {
    ...
    // Get lead/conversion counts for each campaign's source
...
router.get('/analytics/funnel', async (req, res, next) => {
  try {
    ...
    // Calculate total entering funnel for drop-off rates
