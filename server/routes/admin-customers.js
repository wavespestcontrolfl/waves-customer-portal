...
router.get('/:id', async (req, res, next) => {
  try {
    ...
    // minus refunds. customers.lifetime_revenue is never kept in sync, and
    // summing paid invoices misses off-gateway payments recorded directly
    // against the payments table.
