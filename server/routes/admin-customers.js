    ...
    if (Object.keys(updates).length) {
      ...
      try {
        await db.transaction(async (trx) => {
          ...
          // Identity corrections propagate to the CANONICAL account row via
          // the customers_identity_propagate trigger (migration
          // 20260729000003) — one mechanism covering EVERY identity writer,
          // not just this route.
