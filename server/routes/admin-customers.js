  ...
  try {
    ...
    res.json({
      customers: customers.map(c => ({
        ...
        leadSource: c.lead_source, companyName: c.company_name,
  ...
  try {
    ...
    res.json({
      customer: {
        ...
        tier: c.waveguard_tier, monthlyRate: parseFloat(c.monthly_rate || 0),
        memberSince: c.member_since, active: c.active,
        pipelineStage: c.pipeline_stage, leadScore: c.lead_score, leadSource: c.lead_source,
        ...
        lifetimeRevenue: parseFloat(c.lifetime_revenue || 0), totalServices: c.total_services,
