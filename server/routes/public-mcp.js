  ...
  return {
    ...
    quoteApi: {
      ...
      optionalFields: {
        ...
        lotSizeConfirmed: 'boolean — set true when the customer stated or verified the lot size themselves; a confirmed lot takes precedence over property-record data. Mosquito services (mosquito, oneTimeMosquito) price instantly only from a property-record lot or a confirmed one — an unconfirmed lotSqFt returns a manual-review outcome for them.',
      },
