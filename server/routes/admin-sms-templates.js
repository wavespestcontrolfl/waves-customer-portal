...
async function ensureTable() {
  ...
  const templates = [
      ...
      { template_key: 'lead_auto_reply_after_hours', name: 'Lead Auto-Reply (After Hours)', category: 'estimates', body: 'Hello {first_name}! Thanks for reaching out to Waves! What are you interested in — Pest Control, Lawn Care, or a One-Time Service? We\'ll follow up first thing in the morning with a custom quote.', variables: JSON.stringify(['first_name']), sort_order: 22 },
      { template_key: 'lead_service_pest', name: 'Lead Reply — Pest Control Selected', category: 'estimates', body: 'Great, {first_name} — putting together a pest control quote now. Just need to confirm the service address — can you text it over?', variables: JSON.stringify(['first_name']), sort_order: 23 },
      { template_key: 'lead_service_lawn', name: 'Lead Reply — Lawn Care Selected', category: 'estimates', body: 'Great, {first_name} — putting together a lawn care quote now. Just need to confirm the service address — can you text it over?', variables: JSON.stringify(['first_name']), sort_order: 24 },
