...
async function ensureTable() {
  if (!(await db.schema.hasTable('pricing_config'))) {
    ...
    const configs = [
      { config_key: 'pest_base', name: 'Pest Control Base Price', category: 'pest', sort_order: 1, data: JSON.stringify({ base: 112, floor: 89 }) },
      ...
      { config_key: 'rodent_trapping', name: 'Rodent Trapping (Standard — flat $350, unlimited callbacks)', category: 'rodent', sort_order: 6, data: JSON.stringify({ standard_price: 350, base: 350, floor: 350, ceiling_before_custom: 795, included_followups: 'unlimited', active_window_days: null, additional_followup_rate: 0, emergency_multiplier: 1.20, emergency_minimum_surcharge: 75, home_size_adjustments: [{max_sqft:1200,adjustment:0},{max_sqft:2500,adjustment:0},{max_sqft:4000,adjustment:0},{max_sqft:6000,adjustment:0},{max_sqft:'Infinity',adjustment:0,custom_recommended:true}], lot_adjustments: [{max_lot_sqft:10000,adjustment:0},{max_lot_sqft:20000,adjustment:0},{max_lot_sqft:43560,adjustment:0},{max_lot_sqft:'Infinity',adjustment:0,custom_recommended:true}], pressure_adjustments: { light:0, normal:0, moderate:0, heavy:0, severe:0 } }) },
      ...
      { config_key: 'onetime_exclusion', name: 'Exclusion Point Pricing + Access Multipliers', category: 'one_time', sort_order: 9, data: JSON.stringify({ simple: 50, moderate: 95, advanced: 195, specialty_minimum: 275, inspection: 75, inspection_waived_with_service_optin: true, minimums_by_home_sqft: [{max_sqft:1500,minimum:395},{max_sqft:2500,minimum:595},{max_sqft:4000,minimum:895},{max_sqft:'Infinity',minimum:1295,custom_recommended:true}], story_multipliers: { one: 1.00, two: 1.15, three: 1.30 }, roof_multipliers: { shingle: 1.00, flat: 1.00, metal: 1.15, tile: 1.25, steep_or_fragile: 1.35 }, construction_multipliers: { block: 1.00, stucco: 1.05, frame: 1.10, mixed: 1.10 } }) },
