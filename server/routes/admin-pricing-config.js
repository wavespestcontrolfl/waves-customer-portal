...
async function ensureTable() {
  if (!(await db.schema.hasTable('pricing_config'))) {
    ...
    const configs = [
      ...
      { config_key: 'rodent_trapping', name: 'Rodent Trapping (Standard — flat $350, unlimited callbacks)', category: 'rodent', sort_order: 6, data: JSON.stringify({ standard_price: 350, included_followups: 'unlimited', emergency_multiplier: 1.20, emergency_minimum_surcharge: 75 }) },
