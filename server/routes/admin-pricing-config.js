...
async function ensureTable() {
  if (!(await db.schema.hasTable('pricing_config'))) {
    ...
    const configs = [
      ...
      { config_key: 'pest_footprint', name: 'Pest Footprint Modifiers', category: 'pest', sort_order: 2, data: JSON.stringify({ breakpoints: [{sqft:800,adj:-15},{sqft:1200,adj:-10},{sqft:1500,adj:-5},{sqft:2000,adj:0},{sqft:2500,adj:3},{sqft:3000,adj:6},{sqft:4000,adj:10},{sqft:5500,adj:16}] }) },
