...
const AUTOMATIONS = [
  {
    ...
    idempotency: 'estimate.delivery:{estimate_id}:{template_version_id}',
  ...
  },
  {
    ...
    status: 'draft',
    frequencyCap: 'once_per_estimate',
    idempotency: 'estimate.unviewed_followup:{estimate_id}:{template_version_id}',
  ...
  },
  {
    ...
    status: 'draft',
    frequencyCap: 'once_per_estimate',
    idempotency: 'estimate.viewed_followup:{estimate_id}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'estimate.expiring_notice:{estimate_id}:{expires_at}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'estimate.extension_notice:{estimate_id}:{new_expires_at}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'onboarding.24h_reminder:{onboarding_id}:{template_version_id}',
  ...
  },
  {
    ...
    status: 'active',
    frequencyCap: 'once_per_onboarding_session',
    idempotency: 'onboarding.72h_reminder:{onboarding_id}:{template_version_id}',
    conditions: { completed: false },
    exit: { stop_if: ['onboarding.completed', 'onboarding.expired'] },
    dryRunNotes: 'Counts incomplete onboarding sessions when the onboarding table is present.',
  },
  {
    ...
    idempotency: 'onboarding.expiring_notice:{onboarding_id}:{expires_at}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'invoice.sent:{invoice_id}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'invoice.receipt:{invoice_id}:{payment_id}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'payment.failed:{invoice_id}:{attempted_at}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'service.report_ready:{service_record_id}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'project.report_ready:{project_id}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'prep.bed_bug:{scheduled_service_id}:{template_version_id}',
  ...
  },
  {
    ...
    status: 'draft',
    frequencyCap: 'once_per_appointment',
    idempotency: 'prep.cockroach:{scheduled_service_id}:{template_version_id}',
  ...
  },
  {
    ...
    idempotency: 'welcome.new_recurring:{customer_id}:{template_version_id}',
