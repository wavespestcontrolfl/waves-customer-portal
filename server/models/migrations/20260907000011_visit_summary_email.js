...
exports.up = async function up(knex) {
  ...
  if (await knex.schema.hasTable('audit_log')) {
    await require('../../services/audit-log').recordAuditEvent({
      ...
      metadata: { templateKey: KEY, migration: '20260907000011_visit_summary_email' },
      trx: knex, critical: true,
    });
  }
};

// Template versions may have been edited or used by durable deliveries.
// Preserve their identity and history when rolling back application code.
