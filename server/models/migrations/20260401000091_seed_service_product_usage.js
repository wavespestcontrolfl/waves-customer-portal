...
exports.up = async function (knex) {
  ...
  const mappings = [
    ...
    // ── LAWN CARE (per application) ──
    { service_type: 'Lawn Care', product: 'Celsius WG', usage_amount: 0.057, usage_unit: 'oz', usage_per_1000sf: 0.057, is_primary: true, notes: 'Post-emergent herbicide (max 3x/year)' },
    ...
    { service_type: 'Lawn Care', product: 'Acelepryn', usage_amount: 0.46, usage_unit: 'oz', usage_per_1000sf: 0.046, is_primary: true, notes: 'Preventive insecticide — chinch, grubs' },
    ...
    // ── TREE & SHRUB ──
    { service_type: 'Tree & Shrub', product: 'Dominion 2L', usage_amount: 1.0, usage_unit: 'oz', usage_per_1000sf: null, is_primary: true, notes: 'Systemic insecticide — root drench' },
    { service_type: 'Tree & Shrub', product: 'Headway G', usage_amount: 3.0, usage_unit: 'lb', usage_per_1000sf: 3.0, is_primary: false, notes: 'Granular fungicide for ornamentals' },
