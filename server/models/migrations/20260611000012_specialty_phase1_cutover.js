...
const PHASE1_KEYS = [
  ...
  { key: 'lawn_aeration', from: ['one_time_lawn_treatment', 'pest_inspection'], to: 'one_time_lawn_treatment' },
  { key: 'lawn_care_one_time', from: ['one_time_lawn_treatment', 'pest_inspection'], to: 'one_time_lawn_treatment' },
