...
const TEMPLATES = [
  ...
  {
    template_key: 'lead_safe_ack',
    name: 'Lead Safe Acknowledgment',
    category: 'estimates',
    body: 'Hello {first_name}! This is Waves Pest Control. Thanks for reaching out. Someone from our team will follow up with you shortly.',
    variables: ['first_name'],
    sort_order: 32,
  },
  {
