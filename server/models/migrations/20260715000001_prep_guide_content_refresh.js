...
// FAQ rows ride the details block (email renderers already know it) with a
// variant marker the page uses to render single-column question-over-answer
// instead of the two-column service-info table (codex #2741 P3).
...
// without url/url_variable, so the label + url_variable must ride along or
// the email loses its "Open prep guide" button (codex #2741 P2).
