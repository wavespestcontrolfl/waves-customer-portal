  ...
  async autoSync() {
    ...
    try {
      const pricingContent = [
        ...
        'Roach: recurring roach modifiers use one-time Initial Roach Knockdown line items; standalone regular roach uses $202.50/$239/$289 by footprint | WaveGuard Membership: flat $99 (waived with annual prepay)',
        '',
