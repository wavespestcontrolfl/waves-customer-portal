...
const SMS_REACTION_RE = /^(liked|loved|disliked|laughed at|emphasized|questioned)\s+[\u201c"].+[\u201d"]$/i;
const REMOVED_SMS_REACTION_RE = /^removed\s+(?:a\s+)?(?:like|heart|dislike|laugh|emphasis|question mark)\s+from\s+[\u201c"].+[\u201d"]$/i;
