...
const CONTACT_EXPOSURE_RE = new RegExp(`\\b${PRODUCT_NOUN}(?![a-zñáéíóú])[^.?!]{0,40}?\\b(?:in|on|into|en)\\s+(?:his|her|their|my|our|your|the\\s+(?:dog|cat|puppy|kitten|baby|child|kid|toddler|bird|parrot|pet|rabbit)'?s|sus|los|la|mis|su)\\s+(?:eyes?|skin|face|mouth|ojos?|piel|cara|boca)(?![a-zñáéíóú])`, 'i');
