...
const ACCESS_SIGNAL_RE = new RegExp([
  ...
  '\\b(?:re-?ent(?:er|ers|ered|ering|ry)|re-?occup\\w*|dr(?:y|ies|ied|ying)(?!\\s+(?:bait|granul\\w*|pellets?|products?|formulations?|powders?|weather|season|spell|soil|ground|areas?|spots?|climate|conditions?|dusts?|wood|rot|leaves|grass|patches))|rain-?fast)\\b',
