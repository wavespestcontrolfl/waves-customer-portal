...
function reportFindingIsInstruction(affirmed, subjectAt, locationAt, findingVerb, findingEvidenceEnd) {
  ...
  const subjectAside = /(^|,\s*)(\s*(?:i|we|you|he|she|they|it|(?:(?:the|our|your|their)\s+)?(?:technician|tech|customer|client|homeowner|caller|crew|team))(?:\s+(?:am|is|are|was|were|do|does|did|has|have|had|will|would|should|can|could|may|might|must|shall))?),\s*[^,]+,\s*/gi;
