...
const CLASSIFIER_RULES = Object.freeze([
  ...
  { flag: 'payment', re: /(\$\s?\d|\b(?:pay(?:ment|ing)?|paid|fee|fees|sponsor(?:ed|ship)?|compensat(?:e|ion)|invoice|budget\s+for|rate\s+card|purchas(?:e|ed|ing)|buy(?:ing)?|bought|price|pricing|cost(?:s)?)\b)/i },
