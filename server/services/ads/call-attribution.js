...
// row, so whole organic channels (spoke domains, the hub, GBP) are invisible to
// the LTV:CAC / "where to put ad dollars" surfaces even though they drive real
...
// (unchanged behavior for those sources).
