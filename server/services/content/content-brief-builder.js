...
const GATE_RETRY_INSTRUCTIONS = {
  ...
  OFF_FOOTPRINT_CITY_CLAIM: 'Remove every service claim naming a city outside the Waves footprint — either drop the city or rewrite it as a purely educational mention with NO serve/schedule/call/book/your-home language in the same sentence.',
  PRODUCT_CLAIM: 'Remove every professional product name, active ingredient, and claim about what Waves technicians carry or use — describe the product CLASS generically (e.g. "a non-repellent professional perimeter product") and defer specifics to the product label.',
  ...
  COMPARISON_COMPETITOR_IN_PROSE: 'Move every named competitor out of prose, title, and meta — a competitor may be named ONLY inside the <ComparisonTable> itself; in the surrounding copy say "national chains" or "other providers" instead.',
