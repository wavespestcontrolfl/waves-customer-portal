...
const LIST_FRAGMENT_RE = /^\s*(?!(?:We|Our|Waves|WaveGuard)\b)(?:(?:and|or|nor)\s+|[&/+]\s*|(?!(?:We|Our|Waves|WaveGuard)\b)[A-Z][A-Za-z'.&-]*[\s,–—-]*)+(?:(?:year-round|weekly|monthly|quarterly|seasonally|daily|too|as well|and more)[\s,]*)?\.?\s*$/;
