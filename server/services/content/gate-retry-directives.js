...
const GATE_RETRY_INSTRUCTIONS = {
  ...
  AFFILIATE_PRODUCT_NOT_IN_BRIEF: 'Link ONLY the affiliate products your brief lists under affiliate_products, each with EXACTLY the product id, placement and anchor text the brief gives — never substitute another product (even an approved one), change the placement, or reword the anchor; if a listed product does not fit, omit it.',
