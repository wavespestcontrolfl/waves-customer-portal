 ...
 *                  episode (customers.churn_episode_id, carried on the
 *                  request — admin-cancellation termEpisodeOf).
 * @param {string}  [args.termEpisodeKey] the churn episode — without it the
 *                  send stays request-keyed.
