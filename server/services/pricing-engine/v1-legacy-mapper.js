...
const SERVICE_LABEL = {
  ...
  top_dressing: 'Lawn Top Dressing Service',
  dethatching: 'Lawn Dethatching Service',
  plugging: 'Lawn Plugging Service',
  trenching: 'Trenching',
  ...
  german_roach_initial: 'German Roach Initial Service (3-Visit)',
  pest_initial_roach: 'Cockroach Treatment Service',
  ...
  rodent_guarantee: 'Rodent Guarantee Service',
  ...
  rodent_wire_mesh: 'Rodent Wire Mesh Exclusion Service',
  rodent_bird_box: 'Roof-Entry Cover / Bird Box Service',
  foam_drill: 'Termite Foam Service',
  ...
  if (tbLI) {
    ...
    R.tmBait = {
      ...
      ...(tbLI.plan === 'annual_protection' ? {
        ...
        visitsPerYear: tbLI.visitsPerYear,
      } : {}),
    };
  }
