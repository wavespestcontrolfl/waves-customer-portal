...
const RE_SERVICE_PHRASE = "(?:re[-\\s]?service|re[-\\s]?visit(?!\\s+(?:(?:the|my|our|your|this|that|its?|them)\\s+(?!(?:service|visit|treatment|treatments|appointment|spray|spraying|house|home|property|yard|lawn|garden|kitchen|bathroom|bedroom|garage|attic|lanai|patio|pool|cage|inside|outside|interior|exterior|front|back|ants?|roach(?:es)?|cockroach(?:es)?|bugs?|pests?|spiders?|wasps?|hornets?|fleas?|ticks?|mosquito(?:e?s)?|rodents?|rats?|mice|weeds?|between|before|after|soon|asap|today|tomorrow|next|again|on|in|at|us|me|for)\\b)[a-z]|(?!(?:the|my|our|your|this|that|its?|them)\\b)(?!(?:service|visit|treatment|treatments|appointment|spray|spraying|house|home|property|yard|lawn|garden|kitchen|bathroom|bedroom|garage|attic|lanai|patio|pool|cage|inside|outside|interior|exterior|front|back|ants?|roach(?:es)?|cockroach(?:es)?|bugs?|pests?|spiders?|wasps?|hornets?|fleas?|ticks?|mosquito(?:e?s)?|rodents?|rats?|mice|weeds?|between|before|after|soon|asap|today|tomorrow|next|again|on|in|at|us|me|for)\\b)[a-z]))|revisit(?!\\s+(?:(?:the|my|our|your|this|that|its?|them)\\s+(?!(?:service|visit|treatment|treatments|appointment|spray|spraying|house|home|property|yard|lawn|garden|kitchen|bathroom|bedroom|garage|attic|lanai|patio|pool|cage|inside|outside|interior|exterior|front|back|ants?|roach(?:es)?|cockroach(?:es)?|bugs?|pests?|spiders?|wasps?|hornets?|fleas?|ticks?|mosquito(?:e?s)?|rodents?|rats?|mice|weeds?|between|before|after|soon|asap|today|tomorrow|next|again|on|in|at|us|me|for)\\b)[a-z]|(?!(?:the|my|our|your|this|that|its?|them)\\b)(?!(?:service|visit|treatment|treatments|appointment|spray|spraying|house|home|property|yard|lawn|garden|kitchen|bathroom|bedroom|garage|attic|lanai|patio|pool|cage|inside|outside|interior|exterior|front|back|ants?|roach(?:es)?|cockroach(?:es)?|bugs?|pests?|spiders?|wasps?|hornets?|fleas?|ticks?|mosquito(?:e?s)?|rodents?|rats?|mice|weeds?|between|before|after|soon|asap|today|tomorrow|next|again|on|in|at|us|me|for)\\b)[a-z]))|re[-\\s]treat(?:ment)?|retreatment|spray\\s+again|treat\\s+again|come\\s+back\\s+out)";
