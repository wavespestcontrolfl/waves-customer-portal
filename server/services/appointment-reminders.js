          ...
          try {
            ...
            await deliverAppointmentNotice({
              ...
              smsAttempt: () => safeSendAppointment(customer, prefs.raw, async (contact) => {
                ...
                return renderAppointmentPageTemplate(
                  'reminder_24h',
                  // v2: the page carries the detail, so the body keeps only
                  // the time + the fee disclosure and hands off to the link.
                  { first_name: firstName, service_type: serviceLabel, time, appointment_line: appointment24.line, card_hold_policy_line: cardHoldPolicyLine24 },
