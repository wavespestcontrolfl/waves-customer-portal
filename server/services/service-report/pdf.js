...
async function renderServiceReportV1Pdf(data, {
  token, req, logger: callLogger, serviceRecordId, pinnedLawnAssessmentId = null, pinnedWeekPlanSentAt, pinnedLawnHistoryIdentity,
} = {}) {
  ...
  const url = serviceReportViewerUrl(reportToken, req, 'pdf', { pinnedLawnAssessmentId, pinnedWeekPlanSentAt, pinnedLawnHistoryIdentity });
  const provider = selectedPdfRenderer();
