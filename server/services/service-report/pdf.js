...
async function renderServiceReportV1Pdf(data, {
  token, req, logger: callLogger, serviceRecordId, pinnedLawnAssessmentId = null, pinnedWeekPlanSentAt,
} = {}) {
  ...
  const url = serviceReportViewerUrl(reportToken, req, 'pdf', { pinnedLawnAssessmentId, pinnedWeekPlanSentAt });
  const provider = selectedPdfRenderer();
