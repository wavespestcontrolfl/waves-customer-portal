...
// scheduling or coverage words ("When is my application?", "Do you spray
// inside?").
const APPLICATION_WORD_PATTERN = /\b(?:applied|application|chemicals?|products?|spray|label)\b/i;
