...
- price: Capture ANY price the AGENT states on the call, whether or not the caller accepted it — this is broader than quoted_price_usd above, which stays accepted-total-only and unaffected by this field. Never invent a number; leave a subfield null when the call did not say it.
