...
async function findAppliedSmsExtractionFields({ trx = null, scope_id, sms_log_id, twilio_sid }) {
  return (trx || db)('data_hygiene_proposals')
    ...
    .whereIn('status', ['approved', 'auto_applied', 'reverted'])
...
module.exports = {
  ...
  findAppliedSmsExtractionFields,
  isSensitiveProposal,
};
