...
const DURATION_COUNT_BASE = '\\d*\\s?[½¼¾⅓⅔⅛⅜⅝⅞]|\\d+\\s+\\d\\s*\\/\\s*\\d|\\d\\s*\\/\\s*\\d|\\d+(?:\\.\\d+)?|a\\s+few|a\\s+couple(?:\\s+of)?|several|(?:a|one|half\\s+a|two|three)\\s+dozen|dozens\\s+of|(?:one[- ]|a\\s+)?half(?:\\s+of)?\\s+an?|one[- ]half|(?:three[- ])?quarters?\\s+of\\s+an?|(?:\\d+|one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve)[- ]and[- ](?:(?:an?|one)[- ](?:half|quarter|third)|three[- ](?:quarters|fourths)|two[- ]thirds)|(?:one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|thirteen|fourteen|fifteen|sixteen|seventeen|eighteen|nineteen|twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|hundred)(?:[- ](?:one|two|three|four|five|six|seven|eight|nine))?|an?(?:\\s+(?:full|whole|good|solid|mere|quick|short|brief|single))?';
