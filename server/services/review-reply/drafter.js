...
// "program" was missed): negated review evidence never sources it.
const MEMBERSHIP_TERM_RE = /^(?:(?:service|membership|maintenance|protection|recurring|quarterly|monthly|bi-?monthly|annual|yearly)\s+plans?|plan\s+members?|membership|members?|programs?|waveguard|quarterly|bi-?monthly|monthly|annual|yearly)$/i;
