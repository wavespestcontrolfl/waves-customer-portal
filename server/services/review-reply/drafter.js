...
const BANNED_RE = new RegExp([
  ...
  `\\b(?:(?:${DURATION_COUNT})[- ]+(?:seconds?|secs?|minutes?|mins?|hours?|hrs?|days?)|(?:one[- ]|a\\s+)?half[- ]?(?:an?[- ])?hour|(?:three[- ])?quarter[- ]hour|\\d+[- ]?(?:sec|min|hr)s?)\\b[^.]{0,30}\\b(?:before|until|till|then|and\\s+then|prior\\s+to|ahead\\s+of)\\b[^.]{0,30}\\b(?:access\\w*|reopen\\w*|resum\\w*|return\\w*|re-?enter\\w*|back|ready|usable|available|open|normal)\\b`,
  ...
  `\\b(?:(?:${DURATION_COUNT})[- ]+(?:seconds?|secs?|minutes?|mins?|hours?|hrs?|days?)|(?:one[- ]|a\\s+)?half[- ]?(?:an?[- ])?hour|(?:three[- ])?quarter[- ]hour|\\d+[- ]?(?:sec|min|hr)s?)\\s+(?:later|afterwards?|on|thereafter|down\\s+the\\s+(?:road|line))\\b`,
