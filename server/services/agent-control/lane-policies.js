...
const LANE_RUNTIME = {
  ...
  // One call per visit through the adapters (dispatchWithFallback → call rows); the technician reviews the findings before they confirm — GATE_LAWN_VISIT_ASSESSMENT.
