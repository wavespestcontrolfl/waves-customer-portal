...
const LANES = [
  ...
  L('editorial_review', 'Editorial evidence review', 'content/editorial-review.js', 'deep', P('deepAnalysis', 'primary'), P('deepAnalysis', 'fallback')),
  L('editorial_repair', 'Editorial draft repair', 'content/editorial-review.js', 'deep', P('deepAnalysis', 'primary'), P('deepAnalysis', 'fallback')),
  L('editorial_plan_review', 'Editorial answer plan review', 'content/editorial-review.js', 'deep', P('deepAnalysis', 'primary'), P('deepAnalysis', 'fallback')),
