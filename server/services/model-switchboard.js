...
const LANES = [
  ...
  L('estimate_followup', 'Estimate-conversion follow-up SMS', 'estimate-conversion-agent.js', 'voice', R('smsDraftDefault'), P('highStakes', 'fallback'), { note: 'delegates to the SMS drafter' }),
  ...
  L('lawn_visit_narratives', 'Lawn + visit-summary narratives', 'service-report/lawn-report-narrative.js, visit-summary-narrative.js', 'voice', P('customerCopy', 'primary'), P('customerCopy', 'fallback')),
  ...
  L('ib_tools', 'IB email / SMS / procurement tools', 'intelligence-bar/email-tools.js, comms-tools.js, procurement-tools.js', 'reason', T('FLAGSHIP')),
  ...
  L('agent_content', 'Content, blog writer, refresh agents', 'content/content-agent-config.js, content/agents/writer-agent-config.js, refresh-agent-config.js', 'agents', T('FLAGSHIP'), null, { lock: LOCK.agents('Anthropic Managed Agents') }),
