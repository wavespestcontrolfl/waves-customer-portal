const ADMIN_INTEGRATIONS = [
  ...
  },
  {
    ...
    platform: 'Meta',
    description: 'Campaign + insight ingestion for the ads dashboard (ads_read)',
    env: { required: ['META_ADS_ACCESS_TOKEN', 'META_ADS_ACCOUNT_ID'], supporting: ['META_ADS_API_VERSION'] },
    health: { type: 'token-health', key: 'meta_ads', primaryEnvKey: 'META_ADS_ACCESS_TOKEN' },
    gates: [],
  },
  {
    id: 'meta_capi',
    ...
    platform: 'Meta',
    description: 'Server-side conversion uploads to the Meta pixel',
    env: { required: ['META_CAPI_ACCESS_TOKEN', 'META_CAPI_PIXEL_ID'], supporting: ['META_CAPI_API_VERSION'] },
    health: { type: 'token-health', key: 'meta_capi', primaryEnvKey: 'META_CAPI_ACCESS_TOKEN' },
    gates: [],
  },
  {
    id: 'meta_audiences',
    ...
    platform: 'Meta',
    description: 'Hashed customer/lead audience uploads (ads_management)',
    env: { required: ['META_AUDIENCES_ACCESS_TOKEN', 'META_ADS_ACCOUNT_ID'], supporting: ['META_AUDIENCES_API_VERSION'] },
    health: { type: 'token-health', key: 'meta_audiences', primaryEnvKey: 'META_AUDIENCES_ACCESS_TOKEN' },
    gates: [],
  },
  {
    id: 'instagram',
