...
const gates = {
  ...
  // born from the 2026-07-28 Knorr/Riverwalk Saturday-noon miss). Reads
  // call_log + scheduled_services; writes only admin notifications.
  // Off → cron ticks are no-ops.
  ...
  // before their customer record existed (2026-07-17 Knorr voicemail:
  // orphaned for two weeks). Idempotent, never overwrites a non-NULL link.
  // Off → cron ticks are no-ops.
