...
const gates = {
  ...
  // (ADMIN-BUG-R13): with no invoice history, their own invoice through the
  // shared scheduled mint, pay link + unpaid completion text; any other
  // invoice on the visit, or an unclear amount, gets one office alert
