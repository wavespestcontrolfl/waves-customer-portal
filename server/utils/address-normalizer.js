...
const UNIT_FIRST_SEGMENT_RE = /^(?:(?:(?:apt|apartment|unit|ste|suite|bldg|building|fl|floor|spc|space|lot)\.?\s*#?\s*[A-Za-z0-9-]+\s*)+|#\s*[A-Za-z0-9-]+)$/i;
...
const UNIT_FIRST_INLINE_RE = /^\s*((?:(?:apt|apartment|unit|ste|suite|bldg|building|fl|floor|spc|space|lot)\.?\s*#?\s*[A-Za-z0-9-]+\s*)+|#\s*[A-Za-z0-9-]+)\s+(?:at\s+)?(\d.*)$/i;
