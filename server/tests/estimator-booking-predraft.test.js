...
beforeEach(() => {
  jest.clearAllMocks();
  mockState = { firstQueue: [], inserts: [], updates: [], firstError: null };
...
describe('maybePreDraftForBooking — call delegation', () => {
  test('a phone-booked assessment rides the FULL engine call context with quotePromised asserted', async () => {
