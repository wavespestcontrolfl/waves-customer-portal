...
describe('AI property lookup lot-size normalization', () => {
  ...
  test('parses acreage values tied to acre units', () => {
    ...
    expect(coerceLotSize('Block 2 AC 0.25')).toBe(10890);
    expect(coerceLotSize('Section 22 AC 0.25')).toBe(10890);
    ...
    expect(coerceLotSize('AC 13 - plat')).toBeNull();
    expect(coerceLotSize('AC 13 ADJ REF PLAT')).toBeNull();
    expect(coerceLotSize('4 acres 2 parcels')).toBe(174240);
    expect(coerceLotSize('5 acres 2 parcels')).toBe(200000);
  ...
  test('parses fractional acreage formats before decimal fallback', () => {
    ...
    expect(coerceLotSize('Lot 13-1/2 acre')).toBe(21780);
    expect(coerceLotSize('Lot #13 1/2 acre')).toBe(21780);
    expect(coerceLotSize('Lot 2 1/4 acres')).toBe(98010);
  });
  ...
  test('recognizes acre and square-foot abbreviations without using unrelated numbers', () => {
    ...
    expect(coerceLotSize('5 acres 200,000 sqft')).toBe(200000);
    expect(coerceLotSize('5 acres 250,000 sqft')).toBe(200000);
    expect(coerceLotSize('SF 10000')).toBe(10000);
    expect(coerceLotSize('sqft 10000')).toBe(10000);
    expect(coerceLotSize('Lot Size SqFt 10890')).toBe(10890);
    expect(coerceLotSize('lot 10000 sqft')).toBe(10000);
    expect(coerceLotSize('500 sqft 2024 tax record')).toBeNull();
