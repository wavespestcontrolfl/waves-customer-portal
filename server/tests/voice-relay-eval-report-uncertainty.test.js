...
test.each([
  ...
  ['first-person suspicion', ['We suspect that Talstar P was applied.', 'I suspected that Talstar P was applied.'], 'We confirmed that Talstar P was applied.'],
...
test.each([
  ['4044551353', ['It is believed that Talstar P was applied.', 'It was expected that Talstar P was applied.', "It's believed that Talstar P was applied.", 'It’s expected that Talstar P was applied.', 'It is suspected that Talstar P was applied.', 'It is alleged that Talstar P was applied.', 'It was presumed that Talstar P was applied.', "It's alleged that Talstar P was applied."], 'It is confirmed that Talstar P was applied.'],
  ['4044551358', ['It has yet to be confirmed whether Talstar P was applied.', 'It remains to be confirmed whether Talstar P was applied.', "It's yet to be confirmed whether Talstar P was applied.", 'It remains to be confirmed that Talstar P was applied.', 'It has yet to be confirmed that Talstar P was applied.', "It's yet to be verified that Talstar P was applied."], 'It has been confirmed that Talstar P was applied.'],
  ['4044551362', ["I'd say Talstar P was applied.", 'I’d say Talstar P was applied.', "We'd suggest Talstar P was applied.", 'We’d suggest Talstar P was applied.', "It'd indicate Talstar P was applied.", 'It’d indicate Talstar P was applied.'], 'I said Talstar P was applied.'],
])('round-nine report uncertainty %s', (_finding, uncertainCases, definite) => {
  uncertainCases.forEach((text) => expect(grammar.reportFindingIsUncertain(text)).toBe(true));
  expect(grammar.reportFindingIsUncertain(definite)).toBe(false);
});
...
test.each([
  ['4044844584', ['Talstar P looks to have been applied.', 'Talstar P looks like it was applied.', "Talstar P looks like it's been applied.", 'Talstar P looks like it’s been applied.'], ['Talstar P looks clean after it was applied.']],
  ['4044844589', ['Talstar P will be applied tomorrow.', 'Talstar P was applied tomorrow.'], ['Talstar P was applied yesterday instead of tomorrow.', 'Talstar P was applied yesterday as opposed to tomorrow.']],
  ['4044844597', ['The Technician will put Talstar P around the perimeter.', 'THE TECHNICIAN WILL put Talstar P around the perimeter.'], ['The Technician Will put Talstar P around the perimeter.', 'The TECHNICIAN May put Talstar P around the perimeter.']],
  ['4044844605', ['We doubt that Talstar P was applied.', 'We do not doubt that Talstar P might have been applied.'], ['We do not doubt that Talstar P was applied.', "We don't doubt that Talstar P was applied.", 'I didn’t doubt that Talstar P was applied.']],
])('round-eleven report uncertainty %s', (_finding, uncertainCases, definiteCases) => {
  uncertainCases.forEach((text) => expect(grammar.reportFindingIsUncertain(text)).toBe(true));
  definiteCases.forEach((text) => expect(grammar.reportFindingIsUncertain(text)).toBe(false));
});

test.each([
  ['4044990000', ['The technician hoped Talstar P was applied.', 'The customer is hoping Talstar P was applied.', 'They hope Talstar P was applied.', 'They are hoping Talstar P was applied.', 'They were hoping Talstar P was applied.', "They're hoping Talstar P was applied.", 'They’re hoping Talstar P was applied.', "She's hoping Talstar P was applied.", 'He’s hoping Talstar P was applied.'], ['Talstar P was applied as the technician hoped.', 'Talstar P was applied as the customer hoped.', 'Talstar P was applied as they hoped.', 'The technician Hope applied Talstar P.']],
  ['4044990014', ['There was some chance that Talstar P was applied.', 'There was a good chance Talstar P was applied.', 'There remained a possibility Talstar P was applied.'], ['There was confirmation that Talstar P was applied.', 'There remained certainty that Talstar P was applied.']],
])('round-twelve report uncertainty %s', (_finding, uncertainCases, definiteCases) => {
  uncertainCases.forEach((text) => expect(grammar.reportFindingIsUncertain(text)).toBe(true));
  definiteCases.forEach((text) => expect(grammar.reportFindingIsUncertain(text)).toBe(false));
});
