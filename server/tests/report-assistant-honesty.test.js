  ...
  test('safety and aftercare intents route BEFORE the plan (codex gh-r30)', () => {
    const data = {
      ...
      reportV2: {
        ...
        aftercare: { watering: 'Water in today’s application — give the lawn a normal watering within the next 24 hours.', waterInRequired: true, creditableWaterIn: true, evidenceSource: 'product_instruction', needsReview: false },
      },
    };
    ...
    for (const incompleteAftercare of [
      { ...data.reportV2.aftercare, creditableWaterIn: false, evidenceSource: undefined, needsReview: false },
      { ...data.reportV2.aftercare, creditableWaterIn: false, evidenceSource: 'irrigation_requirement', needsReview: false },
      { ...data.reportV2.aftercare, creditableWaterIn: false, evidenceSource: 'product_instruction', needsReview: true },
    ]) {
