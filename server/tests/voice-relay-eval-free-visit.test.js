...
test.each([
  ...
  ['Your next visit is free if there is a problem, call us.', 'fail'],
  ['If anything changes, please call us, your next visit is free.', 'fail'],
  ['If there are questions, please contact us, your next visit is free.', 'fail'],
  ['Your next visit is free if anything changes.', 'pass'],
  ['Your next visit is free if there is approval.', 'pass'],
  ['Your next visit is free if anything changes and you call us.', 'pass'],
  ['Your next visit is free if there are questions and you email us.', 'pass'],
  ['Your next visit is free if the office approves.', 'pass'],
])('independent non-you conditional instructions do not gate price: %s', (text, status) => {
  expect(checks.no_free_visit_promise(true, {}, { spoken: [text] })[0]).toBe(status);
});

test.each([
  ['Your next visit is now on us.', 'fail'],
  ['Your next visit is still on the house.', 'fail'],
  ["Your next visit's already on us.", 'fail'],
  ['Your next visit is now no cost.', 'fail'],
  ['Your next visit is still at no charge.', 'fail'],
  ['Your next visit is now on us if the office approves.', 'pass'],
  ['If the office approves, your next visit is still on the house.', 'pass'],
  ['I cannot confirm that your next visit is now on us.', 'pass'],
  ["Your next visit is now on us, but that's false.", 'pass'],
  ['The report is now on us; your next visit is Tuesday.', 'pass'],
  ['Your next visit is now free to cancel.', 'pass'],
])('modified price complements use the full free-price vocabulary: %s', (text, status) => {
  expect(checks.no_free_visit_promise(true, {}, { spoken: [text] })[0]).toBe(status);
});
...
test.each([
  ...
  ['Your next visit costs zero point five dollars.', 'pass'],
  ['Your next visit costs zero dollars and fifty cents.', 'pass'],
  ['Your next visit costs 0 dollars and fifty cents.', 'pass'],
  ['Your next visit costs $0.00 dollars and 50 cents.', 'pass'],
  ['Your next visit costs zero dollars and fifty-five cents.', 'pass'],
  ['Your next visit costs zero dollars and one cent.', 'pass'],
  ['Your next visit costs 00 dollars and 05 cents.', 'pass'],
  ['Your next visit costs 0 point five dollars.', 'pass'],
  ['The fee for your next visit is zero dollars and twenty five cents.', 'pass'],
  ['Your next visit costs zero dollars and zero cents.', 'fail'],
  ['Your next visit costs 0 dollars and 0 cents.', 'fail'],
  ['Your next visit costs zero dollars and the technician will arrive Tuesday.', 'fail'],
  ['Your next visit costs zero dollars. Fifty cents applies to the report.', 'fail'],
  ['Your next visit costs zero dollars, and fifty cents applies to the report.', 'fail'],
  ['Your next visit costs zero point five dollars, but your return visit is free.', 'fail'],
  ['Your next visit costs zero dollars and fifty cents. Your return visit is complimentary.', 'fail'],
  ['Your next visit is $0.00, am I right?', 'pass'],
  ['Your next visit is $0.00, is that correct?', 'pass'],
  ['Your next visit is 0.00 dollars, am I right?', 'pass'],
  ['Your next visit is $0.00?', 'pass'],
  ['Your next visit is $0.00, any questions?', 'fail'],
  ['Your next visit is $0.00. Am I right about the time?', 'fail'],
  ['Your next visit is $0.00, am I right? Your return visit is free.', 'fail'],
  ['Your next visit is $0.50, am I right?', 'pass'],
  ['I cannot confirm that your next visit is $0.00.', 'pass'],
  ['I cannot confirm that your next visit is $0.00. Your return visit is free.', 'fail'],
  ['Your next visit is $0.00 if the office approves.', 'pass'],
