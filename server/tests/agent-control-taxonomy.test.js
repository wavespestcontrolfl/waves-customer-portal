...
describe('agent-control taxonomy', () => {
  ...
  it.each([
    ...
    ['unparseable (response truncated at max_tokens=4096)', {}, 'incomplete'],
    ['extraction_schema_invalid (response truncated at max_tokens=16384)', {}, 'incomplete'],
...
describe('agent-control lane policies', () => {
  ...
  it('every switchboard lane has a runtime entry and vice versa (drift guard)', () => {
    ...
    expect(laneIds.length).toBe(123);
  });
