...
const domainRow = (over = {}) => ({ id: uid(), domain: 'example.org', source: 'competitor_gap', agent_state: 'qualified', score: 75, spam_score: 2, enriched_at: EARLIER, best_path_id: null, rejected_by: null, updated_at: EARLIER, ...over });
