...
describe('PUT /:id editability-conflict mapping', () => {
  ...
  test.each([
    ...
    ['dun send completed in the lock window (r10)', 'A payment reminder for this invoice just went out — re-check the invoice and try again'],
    ['follow-up send verify fail-closed (r10)', 'Could not verify the follow-up send state — refusing to edit (boom)'],
    ['payment ledger verify fail-closed (r10)', 'Could not verify the payment ledger — refusing to edit (boom)'],
