...
test.each([PITCH, "Please stop texting me. I don't have any leads for you."])(
  'shadow metadata preserves the existing opt-out response and suppression: %s', async (body) => {
