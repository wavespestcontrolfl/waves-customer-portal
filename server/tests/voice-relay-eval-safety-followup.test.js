...
describe('voice relay eval — safety follow-up coverage', () => {
  ...
  ])('supplementary precaution guidance — %s', (text, status) => {
  ...
  ])('supplementary safety guarantee phrases — %s', (text, status) => {
  ...
  ])('supplementary caller safety answers — %s', (caller, agent, status) => {
  ...
  ])('supplementary introductory safety answers — %s / %s', (question, answer, status) => {
