...
jest.mock('../services/content/image-generator', () => ({ generate: jest.fn(), planFor: jest.fn(() => ({ style: 'photo', setting: 'inside a residential garage', timeOfDay: 'late afternoon', vantage: 'eye level' })) }));
