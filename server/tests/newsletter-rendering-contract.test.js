...
describe('newsletter rendering contract', () => {
  test('flagship masthead is "Waves Newsletter" (no "The", no subtitle, 20px) under the canonical portal Waves logo, with the universal footer', () => {
    ...
    expect({
      ...
      wavesLogoCount: occurrenceCount(html, 'waves-logo.png'),
    ...
    }).toMatchInlineSnapshot(`
      {
        ...
        "mastheadUrl": "https://portal.wavespestcontrol.com/waves-logo.png",
        "mastheadWidth": 72,
