...
test.each([
  ...
  ['I was asked to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['I was, according to the report, asked to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['I was asked, according to the report, to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['I was asked, according to the report, to confirm the invoice, Talstar P was applied to the exterior perimeter.', false],
  ['We had been carefully requested to verify whether Talstar P was applied to the exterior perimeter.', true],
  ['I was asked to confirm the invoice, Talstar P was applied to the exterior perimeter.', false],
  ['I was not asked to confirm that Talstar P was applied to the exterior perimeter.', false],
  ['I was able to confirm that Talstar P was applied to the exterior perimeter.', false],
  ['Our licensed and experienced senior service technician asked me to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['Our licensed and experienced senior service technician was asked to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['The technician was, as documented, asked to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm that our licensed and experienced senior service technician applied Talstar P to the exterior perimeter.', true],
  ['Please confirm that after reviewing the report, our licensed and experienced senior service technician applied Talstar P to the exterior perimeter.', true],
  ['Check the invoice, our licensed and experienced senior service technician applied Talstar P to the exterior perimeter.', false],
  ...
  ['Sam asked me to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['The property manager asked me to confirm that Talstar P was applied to the exterior perimeter.', true],
  ['Sam requested confirmation that Talstar P was applied to the exterior perimeter.', true],
  ['Sam asked me to confirm the invoice, Talstar P was applied to the exterior perimeter.', false],
  ['Sam confirmed that Talstar P was applied to the exterior perimeter.', false],
  ['Please do confirm that Talstar P was applied to the exterior perimeter.', true],
  ['Do carefully confirm that Talstar P was applied to the exterior perimeter.', true],
  ['Please carefully do verify that Talstar P was applied to the exterior perimeter.', true],
  ['We do confirm that Talstar P was applied to the exterior perimeter.', false],
  ['We ensure that Talstar P was applied to the exterior perimeter.', false],
  ['I make sure that Talstar P was applied to the exterior perimeter.', false],
  ['They carefully ensure that Talstar P was applied to the exterior perimeter.', false],
  ['We will ensure that Talstar P was applied to the exterior perimeter.', true],
  ['We need to ensure that Talstar P was applied to the exterior perimeter.', true],
  ['Ensure that Talstar P was applied to the exterior perimeter.', true],
  ['You ensure that Talstar P was applied to the exterior perimeter.', true],
  ['I ask that we ensure that Talstar P was applied to the exterior perimeter.', true],
  ['I request that they make sure that Talstar P was applied to the exterior perimeter.', true],
  ['I ask that, according to the report, we ensure that Talstar P was applied to the exterior perimeter.', true],
  ['Check the invoice, we ensure that Talstar P was applied to the exterior perimeter.', false],
  ['Please confirm that although it was raining, Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm that because it was raining, Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm that since it was raining, Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm that despite the rain, Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm that during the rain, Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm, although it was raining, that Talstar P was applied to the exterior perimeter.', true],
  ['I confirmed that although it was raining, Talstar P was applied to the exterior perimeter.', false],
  ['I asked whether Talstar P was applied to the exterior perimeter.', true],
  ['I asked if Talstar P was applied to the exterior perimeter.', true],
  ["I'd like confirmation that Talstar P was applied to the exterior perimeter.", true],
  ['I’d like confirmation that Talstar P was applied to the exterior perimeter.', true],
  ['We would like verification that Talstar P was applied to the exterior perimeter.', true],
  ['I asked whether the invoice was paid, Talstar P was applied to the exterior perimeter.', false],
  ['We received confirmation that Talstar P was applied to the exterior perimeter.', false],
  ['Please confirm that, although it was raining, Talstar P was applied to the exterior perimeter.', true],
  ['Please confirm that, because it was raining, Talstar P was applied to the exterior perimeter.', true],
  ['I asked whether, although it was raining, Talstar P was applied to the exterior perimeter.', true],
  ['I asked if after checking the report, Talstar P was applied to the exterior perimeter.', true],
  ['I confirmed that, although it was raining, Talstar P was applied to the exterior perimeter.', false],
  ['I asked if the invoice was paid, Talstar P was applied to the exterior perimeter.', false],
