...
describe('POST /:id/unvoid refusal mapping', () => {
  ...
  test.each([
    ...
    ['annual-covered linked visit', 'Cannot unvoid — an active annual prepay covers this visit, so its base work is already paid; bill any extras on a new invoice instead'],
