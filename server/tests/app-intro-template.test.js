...
const { TEMPLATE } = require('../models/migrations/20260626000004_seed_app_intro_email_template');
...
describe('app_intro email content contract', () => {
  ...
  test('includes the app screenshots and personalizes the name', () => {
    ...
    expect(html).toContain('app-tracking.png');
    expect(html).toContain('app-visits.png');
