...
| Focus and pending | Nested Escape/focus return, disabled-fieldset containment, stable pending completion geometry, duplicate suppression and retained form values. |
