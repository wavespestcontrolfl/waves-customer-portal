...
Focused migration of Sources within `/admin/knowledge`: comfortable shared cards, fields, buttons, and feedback. Other Wiki panels and page headers remain separate review units.
