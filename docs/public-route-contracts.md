...
completion evidence and replay inputs remain stored unchanged. The shared PDF
storage revision `p9-action-privacy-20260926` makes older cached documents miss
and re-render through this privacy boundary in both public and queued paths.
