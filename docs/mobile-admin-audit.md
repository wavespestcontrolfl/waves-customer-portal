...
> have since been retired — V2 is the only path. The V1 `AdminLayout.jsx` shell
> (referenced below) was deleted and replaced by `AdminLayoutV2.jsx`. Read this file as
