...
| Pricing-formula correctness | 8 | 1,494 independently compared scenarios (+47 engine-only observations), 0 formula mismatches, 2 counted discrepancies (CAD-002 cadence, INP-001 palm entry point); cadence identities hold; discounts exact | remove T&S double-round; cap FIXED discount; reject unpriceable cadences |
