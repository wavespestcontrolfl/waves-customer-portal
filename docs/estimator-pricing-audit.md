...
| 4 | INP-001 | P1 | Palms entered in the admin builder never reach the tree & shrub price: the translator sends `profile.palmCount` (property level) and the pricer only folds *service-line* palms into the per-tree terms. 30 palms: $53.08/mo (admin) vs $95.17/mo (website form, same property). **Update 2026-09-26:** fixed in v4.8 — the admin builder now forwards palm count on the service line (`property-lookup-v2.js:4167-4210`). | Reproduced |
...
|---|---|---|---|
| Palm count | admin (`palmCount`, guarded 1–200), website (`treeShrub.palmCount`), AI (1–200), vision (`estimatedPalmCount`) | **only when on the service line** (`service-pricing.js:2745-2770`); admin translator sends property-level only (`property-lookup-v2.js:3970` sends `{tier:'standard'}`) | **INP-001 P1** — Reproduced: 30 palms $53.08 vs $95.17/mo. **Update 2026-09-26:** fixed in v4.8 (`property-lookup-v2.js:4167-4210`) |
...
| Non-palm tree count | admin (`treeCount`), website, AI, vision | yes (1.5 min/tree, $4/yr) | **INP-002 P2** blank admin field posts explicit 0 → suppresses density fallback ($45.25 vs $58.75/mo). **Update 2026-09-26:** fixed in v4.8 — blank now stays absent (`property-lookup-v2.js:4148-4162`) |
...
| Access difficulty | website/AI only; **admin does not collect** | 0/8/15 min | **INP-004 P2**. **Update 2026-09-26:** fixed in v4.8 — admin now collects it (`property-lookup-v2.js:4167-4210`) |
| 6-visit vs 9-visit | website/AI (`tier`); admin hardcodes `standard` | yes | admin cannot sell 9x T&S through the builder (**INP-004**). **Update 2026-09-26:** fixed in v4.8 — admin now forwards the selected tier (`property-lookup-v2.js:4167-4210`) |
...
- Stinging insects: admin sends none of species/tier/removal → every admin wasp quote is tier-2 paper wasp, no removal (`property-lookup-v2.js:4232-4241`) — **INP-006 P2**. **Update 2026-09-26:** fixed — admin now collects species, scope tier and removal (`EstimateToolViewV2.jsx:3574-3576, 6669, 6678`; `property-lookup-v2.js:4478-4487`).
