...
| 3 | BIL-001 | P1 | 20 completed, billable, non-callback, non-prepaid visits since 2026-06-01 have no invoice within ±3 days (est. $1,530 of visit price); the only signal is `logger.warn` in `admin-dispatch.js:9301`. 128 of 182 per-application customers have no `per_application_fee`. | Data + Static |
