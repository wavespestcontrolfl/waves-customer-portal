...
| Pricing-formula correctness | 8 | 1,493 independently compared scenarios (+47 engine-only observations), 0 price mismatches, 1 cadence mismatch (CAD-002); cadence identities hold; discounts exact | remove T&S double-round; cap FIXED discount; reject unpriceable cadences |
