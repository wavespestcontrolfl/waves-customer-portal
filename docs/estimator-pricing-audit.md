...
- Stinging insects: admin sends none of species/tier/removal → every admin wasp quote is tier-2 paper wasp, no removal (`property-lookup-v2.js:4232-4241`) — **INP-006 P2**. **Update 2026-09-26:** fixed — admin now collects species, scope tier and removal (`EstimateToolViewV2.jsx:3574-3576, 6669, 6678`; `property-lookup-v2.js` `translateV2CallToV1Input`).
...
| Pricing-formula correctness | 8 | 1,784 independently compared scenarios (+61 engine-only observations), 0 formula mismatches, 2 counted discrepancies (CAD-002 cadence, INP-001 palm entry point); cadence identities hold; discounts exact | remove T&S double-round; cap FIXED discount; reject unpriceable cadences |
