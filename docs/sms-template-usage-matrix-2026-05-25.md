...
| Appointment prep tagging | `server/services/appointment-tagger.js` | `pest_prep_cockroach`, `pest_prep_bed_bug` | `renderSmsTemplate` | Logs and skips prep SMS when missing. | `skip_logged` |
