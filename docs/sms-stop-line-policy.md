...
| `missed_call`, `lead_auto_reply_biz`, `voicemail_quote_link`, `dropped_call_address_request`, `booking_abandonment_recovery`, `lead_consultation_link` | Lead first contact — not a customer yet. |
