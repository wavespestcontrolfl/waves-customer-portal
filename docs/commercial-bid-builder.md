...
The commercial proposal editor supports reviewed decimal quantities, unit pricing, private project costing, and fixed validity dates. The branded proposal remains the scope-and-price document.

New unit, costing and validity controls are behind `GATE_COMMERCIAL_BID_BUILDER`, off by default. Unsetting it hides unused controls and leaves saved units, costs and dates visible without editing. The server refuses changes to those fields from a stale editor while the gate is off. Older editors that omit the date preserve the stored hold. Saved quantities and price holds continue to govern documents, invoices and expiry.
...
3. Complete **Project cost sheet · private** with reviewed materials, total crew hours, equipment, travel, monitoring and warranty costs. Each row costs quantity × unit cost × occurrences. Compare one-time revenue plus the selected recurring-revenue years against all matching costs. Missing or invalid costs or revenue withhold profit and margin; this sheet never sets quoted prices.
4. Save, review the quoted quantities, prices and terms, then download the branded proposal.
