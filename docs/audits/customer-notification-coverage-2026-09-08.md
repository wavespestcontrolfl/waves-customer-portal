...
The reminder change extends the existing account preferences and delivery
...
| Customer event | Current coverage, including this reminder change | Customer control and destination | Recommended next action |
| --- | --- | --- | --- |
...
| 72-hour reminder | App choice added by this change; existing timing, one-time email default and explicit-choice rules remain | 72-Hour Appointment Reminder; Visits | Included now. |
| 24-hour reminder | App choice added by this change; existing day-before and quiet-hour rules remain | 24-Hour Service Reminder; Visits | Included now. |
...
The 72-hour/24-hour preference extension is implemented in this change.
