...
export default defineConfig({
  ...
  resolve: { alias: { ...capShimAlias, '@proposal-bid': fileURLToPath(new URL('../shared/proposal-bid.cjs', import.meta.url)), '@lawn-scores': fileURLToPath(new URL('../shared/lawn-scores.cjs', import.meta.url)), '@legacy-visit-money-submission': fileURLToPath(new URL('../shared/legacy-visit-money-submission.cjs', import.meta.url)), '@pricing-regime-marker': fileURLToPath(new URL('../shared/pricing-regime-marker.cjs', import.meta.url)), '@kpi-targets': fileURLToPath(new URL('../shared/kpi-targets.cjs', import.meta.url)) } },
  ...
  optimizeDeps: {
    include: ['@proposal-bid', '@lawn-scores', '@legacy-visit-money-submission', '@pricing-regime-marker', '@kpi-targets', '@waves/irrigation-runtime', '@waves/lawn-cost-floor', '@waves/report-redaction'],
  },
  build: {
    outDir: 'dist',
    ...
    commonjsOptions: {
      include: [/shared\/proposal-bid\.cjs$/, /shared\/lawn-scores\.cjs$/, /shared\/legacy-visit-money-submission\.cjs$/, /shared\/pricing-regime-marker\.cjs$/, /shared\/kpi-targets\.cjs$/, /irrigation-runtime/, /lawn-cost-floor/, /report-redaction/, /node_modules/],
    },
  },
});
