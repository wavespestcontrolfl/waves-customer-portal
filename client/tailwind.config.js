...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'ui-body': ['var(--ui-body-size, 13px)', { lineHeight: 'var(--ui-copy-leading, 1.5)' }],
        'ui-label': ['var(--ui-label-size, 12px)', { lineHeight: 'var(--ui-copy-leading, 1.4)' }],
        'ui-caption': ['var(--ui-caption-size, 11px)', { lineHeight: 'var(--ui-copy-leading, 1.4)' }],
        'ui-field': ['var(--ui-field-size, 13px)', { lineHeight: '1.5' }],
