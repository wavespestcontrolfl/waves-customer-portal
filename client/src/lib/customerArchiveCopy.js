...
export const ARCHIVE_BILLING_NOTE =
  "Auto Pay and any pending automatic charges or payment retries are turned off now. Restoring the customer later does not turn them back on; re-enable Auto Pay from their profile if needed.";
