...
// PostHog web app for toolbar/replay deep links — only matters once HOST is
// the first-party ingest proxy (/ingest, GATE_POSTHOG_INGEST_PROXY) instead of
// PostHog Cloud; identical behavior otherwise.
