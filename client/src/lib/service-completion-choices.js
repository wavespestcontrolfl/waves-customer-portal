...
const lawn = Object.freeze({
  observations: defineChoices("lawn", "observations", observationCatalog.lawn),
...
const treeShrub = Object.freeze({
  observations: defineChoices("tree-shrub", "observations", observationCatalog.tree_shrub),
...
const recurringPest = Object.freeze({
  observations: defineChoices("recurring-pest", "observations", observationCatalog.recurring_pest),
