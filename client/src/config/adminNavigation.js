...
export const ADMIN_NAV_ITEMS = {
  ...
  recovery: {
    ...
    label: "Recovery",
    keywords: ["billing recovery", "missing invoices", "overdue", "needs attention"],
    icon: Banknote,
    adminOnly: true,
  },
  payers: {
    id: "payers",
    keywords: ["billing accounts"],
    path: "/admin/payers",
    label: "Payers",
    icon: Building2,
  ...
  taxes: {
    ...
    path: "/admin/tax",
    label: "Taxes",
    keywords: ["bookkeeping", "accounting", "books and taxes"],
    icon: Receipt,
    adminOnly: true,
  },
  pricing: {
  ...
  toolHealth: {
    id: "toolHealth",
    keywords: ["tool health", "system health"],
...
const WORKSPACE_GROUPS = [
  ...
  { id: "agents", label: "Agents", target: "agents", itemIds: ["agents"], section: "Manage" },
