...
const FALLBACK_ACTIONS = [
  ...
  },
  {
    ...
    group: "Find",
    label: "Pest Overdue",
    prompt: "Which quarterly pest control customers are overdue for service?",
  },
  {
    id: "lawn_overdue",
    group: "Find",
  ...
  },
  {
    ...
    group: "Find",
    label: "Win Back",
    prompt: "Show churned Gold/Platinum customers from the last 6 months",
  },
  {
    id: "tech_perf",
    group: "Analyze",
  ...
  return (
    ...
    >
      ...
      {c.health_score != null && (
        <span
          className={cn(
            "u-nums text-11 font-medium",
            healthLow ? "text-alert-fg" : "text-ink-primary",
          )}
        >
          {c.health_score}
        </span>
      ...
      {c.days_overdue != null && (
        <span
          className={cn(
            "u-nums text-10 font-medium",
            overdueBad ? "text-alert-fg" : "text-ink-secondary",
          )}
        >
        ...
        return (
          <div className="mt-3 border-hairline border-zinc-200 rounded-sm overflow-hidden max-h-[300px] overflow-y-auto">
            ...
            <div className="px-3 py-2 bg-zinc-50 border-b border-hairline border-zinc-200 flex items-center justify-between">
              ...
              {data?.total_matching != null &&
                data.total_matching > list.length && (
