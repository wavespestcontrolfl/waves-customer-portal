  ...
  for (const line of lines) {
    ...
    if (line.match(/^[-•*]\s/)) {
      elements.push(
        ...
        >
          <span style={{ color: D.green, fontSize: 10, marginTop: 5 }}>●</span>
  ...
  return (
    <button
      ...
      style={{
        ...
        padding: "5px 12px",
        borderRadius: 9999,
        background: hover ? `${D.green}22` : D.card,
        border: `1px solid ${hover ? D.green + "55" : D.border}`,
        color: hover ? D.green : "#000",
        fontSize: 12,
        fontWeight: 600,
      ...
      .catch(() => {
        setQuickActions([
          ...
          },
          {
            id: "service_lines",
            label: "Service P&L",
            prompt: "Service line P&L breakdown",
            icon: "",
          },
          {
            id: "tech",
            label: "Tech RPMH",
            prompt: "Rank techs by RPMH",
            icon: "",
          },
          {
            id: "top",
          ...
          },
          {
            id: "ads",
            label: "Ad ROI",
            prompt: "Ad attribution and ROAS",
            icon: "",
          },
        ]);
      });
      ...
      >
        ...
        <div style={{ flex: 1, position: "relative" }}>
          ...
          <input
            ...
            onFocusCapture={(e) =>
              (e.target.style.borderColor = D.green + "66")
            }
            ...
            {loading ? (
              ...
              <button
                ...
                style={{
                  padding: "4px 12px",
                  borderRadius: 6,
                  background: prompt.trim() ? D.green : "transparent",
                  color: prompt.trim() ? D.white : D.muted,
                  border: `1px solid ${prompt.trim() ? D.green : D.border}`,
                  fontSize: 11,
                  fontWeight: 700,
