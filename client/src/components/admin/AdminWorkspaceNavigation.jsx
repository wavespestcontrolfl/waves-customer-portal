...
export default function AdminWorkspaceNavigation({ user, isMobile, onClose, onAsk, onLogout, unreadCount }) {
  ...
  return <UiSurface density="compact" className="flex min-h-0 flex-1 flex-col text-zinc-900">
    ...
    <div className="shrink-0 px-3 py-2">
      <Button variant="secondary" onClick={onAsk} className="w-full !justify-start"><Sparkles size={18} aria-hidden />Ask Waves</Button>
    </div>
