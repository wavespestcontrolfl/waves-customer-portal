...
export default function Customer360Workspace({ selectedId, onSelect, onClose }) {
  return <section className="c360-workspace" aria-label="Customer 360 workspace">
    <div className="c360-workspace-detail">
      ...
      <Customer360Profile key={selectedId} customerId={selectedId} onSelectCustomer={onSelect} onClose={onClose} embedded />
    </div>
  </section>;
}
