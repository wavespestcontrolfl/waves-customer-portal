...
export default function SEOIntelligenceBar({
  context = "seo",
  activeDomain,
  onRefresh,
}) {
        ...
        const fallbacks = {
          seo: [
            ...
            },
            {
              id: "traffic",
              label: "Top Sites",
              prompt: "Rank sites by traffic",
              icon: "",
            },
            {
              id: "drops",
              label: "Drops",
              prompt: "Any ranking drops this week?",
              icon: "",
            },
            {
              id: "queries",
          ...
          reviews: [
            ...
            },
            {
              id: "trends",
              label: "Trends",
              prompt: "Review trend over 6 months",
              icon: "",
            },
          ],
          comms: [
          ...
          banking: [
            {
              id: "balance",
              label: "Balance",
              prompt: "What's my Stripe balance?",
              icon: "Card",
            },
            {
              id: "payouts",
              label: "Payouts",
              prompt: "Recent payouts to the bank",
              icon: "",
            },
            {
              id: "cash_flow",
              label: "Cash Flow",
              prompt: "Cash flow this month",
              icon: "",
            },
          ],
          email: [
