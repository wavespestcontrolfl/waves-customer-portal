...
// Same default as the server's WAVES_ANDROID_APP_URL: empty until the Play
// listing clears review, so the badge stays hidden rather than linking to a
// not-yet-live store page.
