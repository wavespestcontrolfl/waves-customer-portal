...
import {
  ...
  CloudRain, Coins, CreditCard, DollarSign, DoorClosed, Download,
  ...
  Minus, MoreHorizontal, Mouse, Newspaper, Palmtree, Paperclip,
  PartyPopper, PawPrint, Pencil, Phone, Plus, Printer,
