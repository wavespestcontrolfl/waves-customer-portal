...
describe('Consolidated lawn report', () => {
  it('keeps the lawn summary once and omits the separate inspection card', async () => {
    ...
    payload.protocol = { structuredObservations: ['Leaf spotting consistent with gray leaf spot was observed. Location: Back yard.'], actions: ['Tested irrigation coverage'] };
    renderReport(payload);
