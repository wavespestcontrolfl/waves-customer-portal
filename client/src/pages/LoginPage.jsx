          ...
          <div className="portal-login-card" data-glass="card" style={{ position: 'relative' }}>
              ...
              <div>
                ...
                <p className="portal-login-subtitle">
                  {step === 'phone'
                    ...
                    : `If you receive a code at ${phone}, enter it below.`}
                </p>
              </div>
            </div>
            ...
            {step === 'code' && (
              <div className="portal-login-note">
                <Icon name="info" size={16} strokeWidth={2} style={{ marginTop: 1 }} />
                <div>
                  <strong>Didn&rsquo;t receive a code?</strong>{' '}
                  Try resending it or using a different number. If you still need help,{' '}
                  <a href="tel:+19412975749" style={{ color: B.glassNavy, fontWeight: 700, whiteSpace: 'nowrap' }}>
                    call (941) 297-5749
                  </a>.
                </div>
              </div>
