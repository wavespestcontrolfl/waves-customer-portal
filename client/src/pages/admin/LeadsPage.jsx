...
export default function LeadsPage() {
  ...
  return <div style={{ padding:24, maxWidth:1400, margin:'0 auto', color:C.text }}>
    <h1 style={{ margin:'0 0 16px', fontSize:28, fontWeight:400, color:C.heading }}>Lead Attribution & Marketing ROI</h1>

    <SEOIntelligenceBar context="leads" />

    <p style={{ margin:'16px 0 24px', fontSize:14, color:C.muted }}>Track every lead from first touch to conversion</p>
