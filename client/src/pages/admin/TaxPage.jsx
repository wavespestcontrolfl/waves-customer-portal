...
function StatCard({ label, value, color, sub, onClick }) {
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (onClick) e.currentTarget.style.borderColor = color || D.teal;
      }}
      onMouseLeave={(e) => {
...
const TAX_SECTIONS = [
  ...
  { key: "services", label: "Taxability", Icon: ShieldCheck },
  ...
  { key: "filings", label: "Filing Calendar", Icon: CalendarDays },
...
function ServiceTaxabilityTab() {
  ...
  const load = () =>
    adminFetch("/admin/tax/service-taxability")
  ...
  const toggleTaxable = async (s) => {
    ...
    try {
      ...
      setServices((prev) =>
        prev.map((svc) =>
          svc.id === s.id ? { ...svc, isTaxable: !svc.isTaxable } : svc,
        ),
      );
    } catch (err) {
        ...
        >
          ...
          <span
            style={{
              ...
              height: 10,
              borderRadius: "50%",
              background: s.isTaxable ? D.green : D.muted,
              flexShrink: 0,
            }}
          />{" "}
          <div style={{ flex: 1 }}>
          ...
          <Badge color={s.isTaxable ? D.green : D.muted}>
            {s.isTaxable ? "Taxable" : "Exempt"}
          </Badge>
          {s.taxCategory && (
            <Badge color={D.teal} small>
              {s.taxCategory}
            </Badge>
          )}
          {s.flStatuteRef && (
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, makeModel: e.target.value }))
              }
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, depreciationMethod: e.target.value }))
              }
        ...
        .map((e) => (
          ...
          >
            ...
            >
              ...
              <span>
                Depr:{" "}
                <span style={{ fontFamily: MONO, color: D.amber }}>
  ...
  return (
    <div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          {summary.map((c, i) => (
            ...
            >
              ...
              <span style={{ fontFamily: MONO, fontSize: 12, color: D.text }}>
                {fmtM(c.total)}
              </span>{" "}
      ...
      {expenses.map((e) => (
        ...
        >
          {" "}
          <span style={{ fontSize: 11, color: D.muted, minWidth: 70 }}>
            {fmtD(e.expenseDate)}
          </span>{" "}
          <span style={{ fontSize: 12, color: D.heading, flex: 1 }}>
            {e.description}
          </span>
          {e.categoryName && (
            <Badge color={D.teal} small>
          ...
          {e.vendorName && (
            <span style={{ fontSize: 11, color: D.muted }}>{e.vendorName}</span>
          )}
          <span
            style={{
              fontFamily: MONO,
...
function FilingCalendarTab() {
  ...
  const load = useCallback(async () => {
    try {
      const d = await adminFetch("/admin/tax/filings");
      ...
      {upcoming.map((f) => {
        ...
        return (
          <div
            ...
            style={{
              background: D.card,
              border: `1px solid ${du <= 7 ? D.red + "66" : D.border}`,
              borderRadius: 8,
              padding: "12px 14px",
              marginBottom: 6,
            }}
        ...
        <div style={{ marginTop: 20 }}>
          ...
          {completed.map((f) => (
            ...
            >
              ...
              {f.amountPaid && (
                <span
                  style={{ fontFamily: MONO, fontSize: 11, color: D.green }}
                >
                  {fmtM(f.amountPaid)}
                </span>
              )}
...
function AdvisorTab() {
  ...
  useEffect(() => {
    adminFetch("/admin/tax/advisor/reports")
      .then((rpt) => {
  ...
  useEffect(() => {
    adminFetch(`/admin/tax/advisor/alerts?status=${alertFilter}`)
      .then((alt) => {
  ...
  const gradeColor =
    { A: D.green, B: D.teal, C: D.amber, D: D.orange, F: D.red }[r?.grade] ||
    D.muted;
    ...
    <div>
      ...
      >
        ...
        <button
          ...
          disabled={running}
          style={{
            background: running ? D.border : D.purple,
            border: "none",
            borderRadius: 6,
            padding: "6px 16px",
            color: D.heading,
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          >
            ...
            {["new", "reviewed", "acted_on", "dismissed"].map((s) => (
              <button
                ...
                style={{
                  background: alertFilter === s ? D.card : "transparent",
                  border:
                    alertFilter === s
                      ? `1px solid ${D.border}`
          ...
          {alerts.map((a) => (
            ...
            >
              ...
              >
                {" "}
                <Badge color={PRIORITY_COLORS[a.priority]} small>
                  {a.priority}
                </Badge>{" "}
                <Badge color={D.teal} small>
                  {a.type}
        ...
        >
          {reports.slice(0, 8).map((rp) => (
            <button
              ...
              style={{
                background:
                  selectedReport?.id === rp.id ? D.card : "transparent",
                border:
                ...
                padding: "4px 10px",
                fontSize: 11,
                color: selectedReport?.id === rp.id ? D.heading : D.muted,
                cursor: "pointer",
              }}
            >
              ...
              <span
                style={{
                  fontWeight: 700,
                  color:
                    { A: D.green, B: D.teal, C: D.amber }[rp.grade] || D.muted,
                }}
              >
                {rp.grade}
              </span>{" "}
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              {r.regulationChanges.map((rc, i) => (
                ...
                >
                  ...
                  {rc.action_required && (
                    <div style={{ fontSize: 11, color: D.amber, marginTop: 4 }}>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              {r.savingsOpportunities.map((s, i) => (
                ...
                >
                  ...
                  >
                    {" "}
                    <Badge color={PRIORITY_COLORS[s.priority]} small>
                      {s.priority}
                    </Badge>{" "}
                    <span
                      style={{
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              {r.deductionGaps.map((d, i) => (
                ...
                >
                  ...
                  {d.estimated_value && (
                    <span
                      style={{ fontFamily: MONO, fontSize: 12, color: D.green }}
                    >
              ...
              {r.complianceAlerts.map((a, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 6,
                    marginBottom: 3,
                    border: `1px solid ${PRIORITY_COLORS[a.severity] || D.border}44`,
                  }}
                >
                  {" "}
                  <Badge color={PRIORITY_COLORS[a.severity]} small>
                    {a.severity}
                  </Badge>{" "}
                  <span style={{ fontSize: 12, color: D.heading, flex: 1 }}>
                    {a.alert}
...
function ExemptionsTab() {
  ...
  useEffect(() => {
    adminFetch("/admin/tax/exemptions")
      .then((d) => setExemptions(d.exemptions || []))
      .catch(() => {});
  }, []);
  return (
    <div>
        ...
        exemptions.map((e) => (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <Badge color={e.verified ? D.green : D.amber}>
  ...
  return (
    <div>
      ...
      >
        ...
        >
          {syncing ? "Syncing Bouncie..." : " Sync from Bouncie"}
        </button>{" "}
        <div style={{ display: "flex", gap: 6, alignItems: "flex-end" }}>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, start_address: e.target.value }))
              }
              placeholder="Start"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, end_address: e.target.value }))
              }
              placeholder="End"
              style={{ ...inputStyle, width: 140 }}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, distance_miles: e.target.value }))
              }
              placeholder="0.0"
              step="0.1"
            ...
            <tbody>
              {entries.slice(0, 50).map((e, i) => (
                ...
                >
                  ...
                  <td style={{ padding: "8px 10px" }}>
                    <Badge
                      color={e.source === "bouncie" ? D.teal : D.muted}
                      small
                    >
                      {e.source || "manual"}
                    </Badge>
    ...
    >
      ...
      <span
        style={{
          ...
          fontSize: 13,
          fontWeight: bold ? 700 : 400,
          color: color || (bold ? D.heading : D.text),
          textAlign: "right",
        }}
      >
        {fmtM(value)}
      ...
      >
        {periods.map((p) => (
          <button
            ...
            style={{
              background: period === p.id ? D.card : "transparent",
              border:
                period === p.id
                  ? `1px solid ${D.border}`
                  : "1px solid transparent",
              borderRadius: 6,
              padding: "6px 12px",
              color: period === p.id ? D.heading : D.muted,
              fontSize: 12,
              cursor: "pointer",
      ...
      {loading ? (
        ...
        >
          ...
          <PnlRow
            ...
            bold
            color={pnl.grossProfit >= 0 ? D.green : D.red}
          />{" "}
          <div
            style={{
              display: "flex",
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button
              ...
              disabled={downloading === "tax-package"}
              style={{
                background: D.teal,
                border: "none",
                borderRadius: 8,
                ...
                fontWeight: 700,
                cursor:
                  downloading === "tax-package" ? "not-allowed" : "pointer",
                opacity: downloading === "tax-package" ? 0.6 : 1,
              }}
            >
        ...
        >
          ...
          <table
            style={{
              width: "100%",
              borderCollapse: "collapse",
              minWidth: isMobile ? 650 : undefined,
            }}
          >
            {" "}
            <thead>
              ...
              {invoices.map((inv, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: "8px 10px" }}>
                      <Badge color={bucketColor(inv.bucket)}>
                        {inv.bucket === "90+"
                          ? "90+ days"
                          : inv.bucket === "60"
                            ? "60 days"
        ...
        <>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 6,
                      marginBottom: 3,
                      border: `1px solid ${days <= 7 ? D.red + "66" : D.border}`,
                    }}
                  >
                    {" "}
                    <Badge color={STATUS_COLORS[dl.status]}>
                      {dl.status}
                    </Badge>{" "}
                    <span style={{ fontSize: 12, color: D.heading, flex: 1 }}>
                      {dl.title}
                    ...
                    <span
                      style={{
                        ...
                        fontWeight: 700,
                        color:
                          days <= 7 ? D.red : days <= 30 ? D.amber : D.muted,
                      }}
                    >
                      {days}d
                    </span>{" "}
          ...
          >
                ...
                <div style={{ fontSize: 12 }}>
                  {[
                    ...
                    [
                      ...
                      quickPnl.grossProfit >= 0 ? D.green : D.red,
                    ],
                    ["OpEx", quickPnl.operatingExpenses?.total, D.text],
                    [
                      "Net Income",
                      quickPnl.netIncome,
                      quickPnl.netIncome >= 0 ? D.green : D.red,
                    ],
                  ].map(([label, val, color]) => (
                    <div
                      key={label}
            ...
            <div
              ...
              style={{
                background: D.card,
                border: `1px solid ${arSummary && arSummary.total > 500 ? D.red + "66" : D.border}`,
                borderRadius: 10,
                padding: "14px 18px",
                cursor: "pointer",
              }}
                ...
                <>
                  ...
                  <div
                    style={{
                      ...
                      fontSize: 22,
                      fontWeight: 700,
                      color: arSummary.total > 500 ? D.red : D.heading,
                      marginBottom: 4,
                    }}
                  >
