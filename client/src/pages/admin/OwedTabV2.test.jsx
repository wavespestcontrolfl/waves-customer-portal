...
describe("OwedTabV2", () => {
  ...
  it("labels due state honestly", () => {
    ...
    // A snoozed callback is owed when the snooze ends, not at its passed deadline.
    expect(dueLabel({ overdue: false, due_at: null, effective_due_at: "2026-09-05T14:00:00Z", snoozed_until: "2026-09-05T18:00:00Z" }, now))
      .toEqual({ text: expect.stringMatching(/^Snoozed until /), tone: "neutral" });
    expect(dueLabel({ overdue: false, due_at: null, effective_due_at: "2026-09-05T14:00:00Z", snoozed_until: "2026-09-05T14:30:00Z" }, now).tone).toBe("alert");
