...
// (A/B/C/D/F) stay distinct (mirrors CustomerHealthPage).
const COLORS = {
  bg: '#F4F4F5',
  card: '#FFFFFF',
  cardHover: '#FAFAFA',
...
// ---------------------------------------------------------------------------
// CustomerHealthSection — embeddable wrapper (no page header or rescore button)
// ---------------------------------------------------------------------------
...
export { CustomerHealthSection, DashboardTab, ScoresTab, AlertsTab, SequencesTab };
