...
export default function EquipmentCalibrationPanel() {
  ...
  const loadReconciliation = useCallback(() => {
    ...
    return adminFetch("/admin/equipment-systems/reconciliation").then(d => setReconciliation(d)).catch(() => setReconciliation(null)).finally(() => setReconciliationLoading(false));
  }, []);
  ...
  const canVerify = !!activeCalibration && verificationComputedRate != null && !!verifyDate && !verifying;
    ...
    margin: "0 auto"
      ...
      marginBottom: 16
        ...
        color: D.text
          ...
          color: D.muted
                  ...
                  Verified {formatETDate(activeCalibration.verified_at)}
          ...
          background: D.card
            ...
            marginBottom: 10
                ...
                marginBottom: 4
                      ...
                      <input type="number" inputMode="numeric" step="1" value={verifyTestAreaSqft} onChange={e => setVerifyTestAreaSqft(e.target.value)} style={inputStyle} />
                    </div>
                    <div>
                      <div style={{
                color: D.muted,
                marginBottom: 4
                      ...
                      <input type="number" inputMode="decimal" step="0.01" value={verifyCapturedGallons} onChange={e => setVerifyCapturedGallons(e.target.value)} style={inputStyle} />
                    </div>
                    <div>
                      <div style={{
                color: D.muted,
                marginBottom: 4
                      ...
                      <input type="date" value={verifyDate} onChange={e => setVerifyDate(e.target.value)} style={inputStyle} />
                    </div>
                  </div>
                  <div style={{
            marginBottom: 10,
      ...
      marginBottom: 16
        ...
        marginBottom: 12
          ...
          <input type="number" inputMode="decimal" step="1" placeholder="e.g. 1000" value={testAreaSqft} onChange={e => setTestAreaSqft(e.target.value)} style={inputStyle} />{" "}
        </div>{" "}
        <div style={{
        marginBottom: 12
      }}>
          ...
          <input type="number" inputMode="decimal" step="0.01" placeholder="e.g. 2.0" value={capturedGallons} onChange={e => setCapturedGallons(e.target.value)} style={inputStyle} />{" "}
        </div>
        ...
        marginBottom: 12
          ...
          <div>
            ...
            <input type="number" inputMode="decimal" step="1" value={pressurePsi} onChange={e => setPressurePsi(e.target.value)} style={inputStyle} />{" "}
          </div>{" "}
          <div>
            {" "}
            <div style={{
            ...
            <input type="text" value={enginRpm} onChange={e => setEngineRpm(e.target.value)} style={inputStyle} />{" "}
          </div>{" "}
        </div>{" "}
        <div style={{
        marginBottom: 12
