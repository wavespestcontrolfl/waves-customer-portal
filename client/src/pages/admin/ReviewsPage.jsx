  ...
  return (
    ...
    >
      {Array.from({ length: 5 }, (_, i) => (
        <span key={i} style={{ color: i < count ? D.amber : "#334155" }}>
          Star
        </span>
      ))}
    </span>
      ...
      >
        {locations.map((l) => (
          ...
          >
            ...
            <div style={{ fontSize: 11, color: l.openNow ? D.green : D.red }}>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 13,
                  fontWeight: 500,
                  background: locTab === t.key ? D.teal : "transparent",
                  color: locTab === t.key ? D.white : D.muted,
            ...
            >
              ...
              >
                ...
                {[
                  ...
                  {
                    label: "Status",
                    value: loc.status === "OPERATIONAL" ? "Open" : loc.status,
                  },
              ...
              >
                ...
                >
                  ...
                  <div style={{ fontSize: 14, color: D.muted, marginTop: 8 }}>
                    {loc.totalReviews} reviews on Google
                  </div>{" "}
                  <div
                    style={{
                      display: "flex",
                ...
                >
                  ...
                  >
                    {" "}
                    <a
                      href={`https://business.google.com/dashboard/l/${loc.placeId}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        padding: "10px 14px",
                    ...
                    <a
                      href={`https://business.google.com/posts/l/${loc.placeId}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        padding: "10px 14px",
                    ...
                    <a
                      href={`https://business.google.com/messaging/l/${loc.placeId}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{
                        padding: "10px 14px",
              ...
              >
                ...
                <span
                  style={{
                    ...
                    height: 10,
                    borderRadius: "50%",
                    background: loc.openNow ? D.green : D.red,
                  }}
                />{" "}
                <span
                  style={{
                    fontSize: 14,
                    color: loc.openNow ? D.green : D.red,
                    fontWeight: 600,
                  }}
                >
                  {loc.openNow ? "Currently Open" : "Currently Closed"}
                </span>{" "}
              </div>
              {(loc.hours || []).length > 0 ? (
                loc.hours.map((h, i) => {
          ...
          {locTab === "photos" && (
            <div>
              ...
              >
                {" "}
                <div
                  style={{ fontSize: 16, fontWeight: 600, color: D.heading }}
                >
                  {loc.name} Photos ({(loc.photos || []).length})
                </div>{" "}
                <a
                  href={`https://business.google.com/photos/l/${loc.placeId}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{
                    padding: "8px 16px",
          ...
          {locTab === "export" && (
            ...
            >
              ...
              <div style={{ fontSize: 13, color: D.muted, marginBottom: 20 }}>
                Download all synced reviews across all locations as a CSV file.
              </div>{" "}
              <button
