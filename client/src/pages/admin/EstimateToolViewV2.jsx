  ...
  async function doGenerate(overrides = {}) {
    ...
    try {
      ...
      if (form.svcInjection) {
        ...
        // malformed entry is silently dropped by parsePositiveInteger and an
        // oversized one is clamped to 200 by the pricer — either way the
        // estimate would quote the wrong palm count with no error and no
        // review marker. Same 1–200 contract as the public route and the
        // intent schema.
