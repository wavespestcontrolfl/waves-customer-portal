...
// V1 default export retired.
//
// The default `function SchedulePage()` (~482 lines) was the legacy
// schedule page mounted at /admin/schedule and (behind the dispatch-v2
// off-branch) /admin/dispatch. Both routes now resolve to V2:
//   /admin/schedule → redirects to /admin/dispatch?tab=schedule
//   /admin/dispatch → AdminDispatchPage (Board tab + DispatchPageV2)
//
// This file is retained as a shared module — the named exports above
// are still consumed by V2 surfaces:
...
//
// V1-only imports (TechMatchPanel, CSRPanel, RevenuePanel,
// InsightsPanel, ViewModeSelector/WeekView/MonthView from
// CalendarViews, CreateAppointmentModal, HorizontalScroll,
// useIsMobile) were also removed; CalendarViews.jsx and
// DispatchGate.jsx are deleted in the same PR as orphans.
