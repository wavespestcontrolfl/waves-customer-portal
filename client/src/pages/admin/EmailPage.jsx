...
export default function EmailPage() {
  ...
  const handleStar = async (e, email) => {
    e.stopPropagation();
    try {
      const r = await adminFetch(`/api/admin/email/message/${email.id}/star`, {
        method: "POST",
      });
      const d = await r.json();
      setEmails((prev) =>
  ...
  const handleArchive = async (emailId) => {
    try {
      await adminFetch(`/api/admin/email/message/${emailId}/archive`, {
        method: "POST",
      });
  ...
  const handleTrash = async (emailId) => {
    try {
      await adminFetch(`/api/admin/email/message/${emailId}/trash`, {
        method: "POST",
      });
      setEmails((prev) => prev.filter((e) => e.id !== emailId));
      if (selectedEmail?.id === emailId) setSelectedEmail(null);
  ...
  const handleAiDraft = async () => {
    ...
    try {
      const r = await adminFetch(
        `/api/admin/email/message/${selectedEmail.id}/ai-draft`,
        { method: "POST" },
      );
      const d = await r.json();
      if (d.reply_draft) {
        ...
        <>
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          height: 8,
                          borderRadius: "50%",
                          background: email.is_read ? "transparent" : D.teal,
                          flexShrink: 0,
                          marginTop: 7,
                        }}
                      />
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          ...
                          <div
                            style={{
                              ...
                              color: email.is_read ? D.muted : D.heading,
                              overflow: "hidden",
                        ...
                        <div
                          style={{
                            ...
                            color: email.is_read ? D.muted : D.text,
                            overflow: "hidden",
                            textOverflow: "ellipsis",
                            whiteSpace: "nowrap",
                            marginBottom: 2,
                      ...
                      >
                        ...
                        >
                          ...
                          {draftResult && (
                            ...
                            >
                              {"\u2713"} AI draft loaded — review and edit
                              before sending
                            </div>
                          )}
                          <div
          ...
          {total > 50 && (
            ...
            >
              ...
              <span
                style={{ padding: "6px 14px", fontSize: 12, color: D.muted }}
              >
              ...
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${D.border}`,
                  background: "transparent",
                  color: page >= Math.ceil(total / 50) ? D.muted : D.text,
