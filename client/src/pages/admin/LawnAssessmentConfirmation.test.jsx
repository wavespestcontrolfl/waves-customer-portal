...
beforeEach(() => {
  ...
  vi.stubGlobal('fetch', vi.fn(async (url) => {
    ...
    if (url.endsWith('lawn-assessment/assess')) data = { assessment, adjustedScores: scores, displayScores: scores };
...
it.each([null, 0])('preserves an unavailable or genuinely zero score when reloading and posting: %s', async (value) => {
  ...
  expect(screen.getAllByText(value == null ? '—' : '0/100')).toHaveLength(4);
