...
function LoadingState() {
  return (
    <div className="min-h-screen bg-[#f7f4ee] px-4 py-10">
      <div className="mx-auto max-w-3xl rounded-md border border-zinc-200 bg-white p-6 text-zinc-600">
      ...
      {Array.isArray(section.bullets) && section.bullets.length > 0 && (
        <ul className="mt-4 grid gap-2 text-sm leading-6 text-zinc-700 md:grid-cols-2">
          {section.bullets.map((bullet, index) => (
            <li key={`${section.key}-${index}`} className="flex gap-2 rounded-md border border-zinc-200 bg-zinc-50 p-3">
    ...
    <div className="min-h-screen bg-[#f7f4ee] text-zinc-950">
      ...
      <main>
        ...
        <section className="mx-auto max-w-6xl px-4 pb-12">
          <div className="flex flex-col items-start justify-between gap-4 rounded-md bg-zinc-950 p-5 text-white md:flex-row md:items-center">
            <div>
