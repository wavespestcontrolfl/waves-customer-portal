...
const SERVICE_LANDING_CONFIGS = {
  ...
  flea: {
    title: 'Get a Flea Treatment Estimate.',
    subtitle: 'Choose single-visit relief or a two-visit elimination package with conditional retreat support.',
    leftTitle: 'Flea Treatment Options.',
    leftSubtitle: 'Waves quotes knockdown visits and two-visit flea packages with clear prep, pet-source, and exterior-source expectations.',
    interest: 'other',
    otherService: 'flea',
    startKey: 'name',
  },
              ...
              <div>
                ...
                {satellite?.closeUrl && (
                  <div style={{ marginBottom: 16, borderRadius: 12, overflow: 'hidden', border: `1px solid ${COLORS.slate200}` }}>
                    <img
                      // ph-no-capture blocks the property satellite image from
                      // session replay — masking text/inputs doesn't hide images.
