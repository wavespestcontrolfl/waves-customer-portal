...
- **Estimate follow-up truth scope** (`estimate-followup-copy.js`):
  ...
  The money-back guarantee has NO 90-day window (owner 2026-09-26): free
  re-treats between visits, and a refund of the most recent service payment
  if a covered problem can't be solved. Never reintroduce "90-day
  money-back" or "if you don't love it, you don't pay" on any surface.
